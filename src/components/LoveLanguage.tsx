...
export default function LoveLanguage() {
  return (
    <div className="py-3 sm:py-3 px-4 sm:px-6 text-center relative">
      ...
      >
        <h2 className="text-4xl sm:text-5xl md:text-6xl text-love font-romantic mb-4">
          Why You Are Special
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 max-w-5xl mx-auto relative z-10">
        {reasons.map((reason, index) => (
          ...
          >
            <div className={`bg-gradient-to-br ${reason.gradient} p-6 sm:p-8 rounded-3xl shadow-love hover:shadow-2xl transition-all duration-300 border-2 border-white relative overflow-hidden`}>
