...
export default function Story() {
  return (
    <div className="py-3 sm:py-3 px-4 sm:px-6 relative">
      {/* Decorative Elements */}
      ...
      >
        <h2 className="text-4xl sm:text-5xl md:text-6xl text-center text-love font-romantic mb-4">
          Our Story
        </h2>
        <div className="w-20 sm:w-24 h-1 bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400 mx-auto rounded-full"></div>
      </motion.div>
        ...
        {memories.map((memory, index) => (
          ...
          >
            <motion.div
              ...
              className={`p-6 sm:p-8 bg-gradient-to-br ${memory.color} rounded-3xl shadow-love border-2 border-white backdrop-blur-sm relative overflow-hidden group`}
            >
              {/* Decorative corner */}
              ...
              <div className="text-center">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-elegant font-bold text-love mb-3">
                    {memory.title}
                  </h3>
